<spring:message code="title.actorDirectors" var="pageTitle" />
<template:displayPost htmlTitle="${pageTitle}" bodyTitle="${pageTitle}">
  
  <jsp:attribute name="displayContent"><br/>
  
	<h2><spring:message code="advancedQueries.actorDirectors"/></h2>
	<form:form method="POST" action="actorDirectors" 
