...
<template:chatRoom htmlTitle="${pageTitle} " bodyTitle="${pageTitle} ${firstUser} ${secondUser}">
 		 		    
    	<!--h2><c:out value="${firstUser} ${secondUser}" /></h2-->
    	<br/>
        ...
        <script type="text/javascript">
            var send, disconnect, acceptChat, requestPrivate;
            $(document).ready(function() {
                ...
                try {                   	
                	server = new WebSocket('ws://' + window.location.host +
                            '<c:url value="/privateChatEndpoint/${firstUser}/${secondUser}" />');
